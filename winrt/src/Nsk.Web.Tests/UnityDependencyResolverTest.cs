...
namespace ManagedDesigns.Nsk.Web.Tests
{
    ...
    /// <summary>
    ///This is a test class for UnityDependencyResolverTest and is intended
    ///to contain all UnityDependencyResolverTest Unit Tests
    ///</summary>
    [TestClass()]
    public class UnityDependencyResolverTest
    {
        ...
        [TestMethod()]
        public void UnityDependency_Constructor_should_Throw_on_null_Container()
        {
            Executing.This(
                    () => new UnityDependencyResolver(null)
                ).
                Should().
